          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10">
            ...
            <div className="lg:col-span-3 space-y-4">
              ...
              <ul className="space-y-2.5 text-white/80 text-sm">
                ...
                <li><Link href="/donate" className="hover:text-[var(--kcf-pink)] font-semibold transition-colors">Donate ❤️</Link></li>
                <li><Link href="/get-involved?type=volunteer" className="hover:text-white transition-colors">Volunteer Application 🤝</Link></li>
                <li><Link href="/get-involved?type=partner" className="hover:text-white transition-colors">Partner With Us 🏛️</Link></li>
            ...
            <div className="lg:col-span-4 space-y-6">
              <div>
                ...
                <p className="text-white/70 text-xs mb-4">
                  Follow our journey and daily updates across our official social channels:
                </p>
